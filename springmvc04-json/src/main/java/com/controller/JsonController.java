...
public class JsonController {
    /**
     * @ResponseBody
     * 作用：使方法的返回值不再去查找视图页面，而是直接返回数据响应前端
     * 除了将字符串直接返回给前端之外，还可以将任何一种类型响应前端
    ...
    public List<Student> getList() {
        Student s1 = new Student(001, "大明", new Date());
        Student s2 = new Student(002, "王二", new Date());
        Student s3 = new Student(003, "小马", new Date());
